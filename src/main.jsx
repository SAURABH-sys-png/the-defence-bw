...
function App() {
  ...
  useEffect(() => {
    ...
    document.title = titles[currentView] || "DefenceRoger | Defence Eligibility & Resources";
    
    // Update meta tags dynamically for SEO if they exist, or create them
    ...
    const descriptions = {
      home: "Read premium blogs, tips, and strategies for UPSC NDA, CDS, AFCAT preparation and Services Selection Board (SSB) interviews.",
      'ssb-stories': "Read 10+ inspiring, recommended stories of candidates who cleared various SSBs for Army, Navy, and Air Force.",
    ...
    metaDescription.content = descriptions[currentView] || "Defence eligibility and resource portal for NDA, CDS, AFCAT, and SSB prep.";
  }, [currentView]);
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between">
      ...
      {/* Footer component styled directly */}
        ...
        <div className="container mx-auto px-6 grid md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button onClick={() => setCurrentView("calculator")} className="hover:text-white transition-colors">
                  Eligibility Calculator
                </button>
              </li>
              <li>
                <button onClick={() => setCurrentView("ssb-stories")} className="hover:text-white transition-colors">
                  Recommended SSB Stories
                </button>
              </li>
              <li>
                <button onClick={() => setCurrentView("mocks")} className="hover:text-white transition-colors">
                  PYQs & Mock PDFs
                </button>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {["NDA 2026", "CDS 2026", "AFCAT Exam", "SSB Interview", "UPSC Written Test", "Officer Like Qualities"].map((tag) => (
